...
const EditRecipePage = () => {
    const { id } = useParams();
    console.log('id on Edit page', id);
    ...
    return (
        <div>
            {JSON.parse(selectedRecipe).map(recipe => {
                useEffect(()=> {
                        ...
                        <form onSubmit={onSubmit}>
                            ...
                            <br />
                                {JSON.parse(recipe.ingredients).map((ingredient, index) => {
                                    // const [thisIngredient, setThisIngredient] = useState(ingredient.ingredient);
                                    // const [thisAmount, SetThisAmount]
